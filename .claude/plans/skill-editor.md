...
Source spec: `docs/specs/SPEC-06-skill-editor.md` (Status: ready). This plan
translates its Goals G1–G7, Acceptance criteria AC-1–AC-32, and Task
checklist T1–T16 into ordered implementation steps. AC/T numbers below refer
to that spec; re-read it (not this plan) for the exact EARS wording when a
step's intent is unclear.
