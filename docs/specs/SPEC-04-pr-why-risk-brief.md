...
`docs/2026-08-07-pr-brief-plan.md` — заздалегідь узгоджений, частково
...
## Реконсиляція зі старим планом (`docs/2026-08-07-pr-brief-plan.md`)
...
- **"Prior PRs touching these files" футер** — покритий старим планом
  (`docs/2026-08-07-pr-brief-plan.md`, розділ 3), не частина офіційних AC
...
- [ ] T11 Cross-model review нотатка (процесний артефакт, не код) —
      ...
      уже наявного `docs/2026-08-03-intent-layer-review.md`) — критерій
